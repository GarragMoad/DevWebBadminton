 ...
 */
final class Version20241206155110 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE equipe (id INT AUTO_INCREMENT NOT NULL, club_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', capitaine_id INT NOT NULL, nom_equipe VARCHAR(15) NOT NULL, numero_equipe VARCHAR(10) NOT NULL, INDEX IDX_2449BA1561190A32 (club_id), INDEX IDX_2449BA152A10D79E (capitaine_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reception (id INT AUTO_INCREMENT NOT NULL, club_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', type_reception_id INT NOT NULL, jour_id INT NOT NULL, horaire_debut DATE NOT NULL, horaire_fin DATE NOT NULL, INDEX IDX_50D6852F61190A32 (club_id), INDEX IDX_50D6852FFB576557 (type_reception_id), INDEX IDX_50D6852F220C6AD0 (jour_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
